...
export class Stock5YDataService {
 ...
 constructor(private http: HttpClient) {}
  ...
  get5YData(symbol: String): Observable<StockDataIntraMonth[]> {
      // const url = `${this.apiUrl}?function=TIME_SERIES_WEEKLY&symbol=${symbol}&apikey=${this.apiKey}`;
